...
var createTrail = function (event) {
...
var getTrailsList = function (_event) {
  return __awaiter(void 0, void 0, void 0, function () {
    var res;
    return __generator(this, function (_a) {
      switch (_a.label) {
...
var fetchTrailById = function (id) {
  return __awaiter(void 0, void 0, void 0, function () {
    var res;
    return __generator(this, function (_a) {
      switch (_a.label) {
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          _b.trys.push([0, 2, , 3]);
          id =
            (_a = event.pathParameters) === null || _a === void 0
              ? void 0
              : _a.id;
...
var updateTrail = function (event) {
  return __awaiter(void 0, void 0, void 0, function () {
          ...
          return [
            ...
            dynamoDb
              .put({
                TableName: tableName,
                Item: __assign(
                  { primary_key: id, updatedAt: timestamp },
                  trail
                ),
              })
              .promise(),
...
var deleteTrail = function (event) {
  return __awaiter(void 0, void 0, void 0, function () {
    var id, e_4;
    var _a;
    return __generator(this, function (_b) {
