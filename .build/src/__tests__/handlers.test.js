                ...
                return {
                    ...
                    scan: jest.fn().mockImplementation(() => {
                        return {
                            promise: jest
                                .fn()
                                .mockImplementation(() => Promise.resolve({ Items: { Hi: "bb" } })),
                        };
                    }),
...
describe("Handle CRUD request", () => {
    ...
    it("should return the correct trails", async () => {
        ...
        const res = await (0, handlers_1.getTrailsList)(getListMockEvent);
    ...
    it("should return the correct trail", async () => {
        ...
        const res = await (0, handlers_1.getTrail)(getTrailMockEvent);
    ...
    it("should update the correct trail", async () => {
        ...
        const res = await (0, handlers_1.updateTrail)(updateMockEvent);
    ...
    it("should delete the correct trail", async () => {
        ...
        const res = await (0, handlers_1.deleteTrail)(deleteMockEvent);
