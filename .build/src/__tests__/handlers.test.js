...
describe("Handle Create a trail request", function () {
    beforeEach(function () {
        mockResponse = {
            statusCode: 201,
            body: "This is a test",
    ...
    it("should call the creatTrail method", function () { return __awaiter(void 0, void 0, void 0, function () {
        var res;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, handlers_1.createTrail)(mockEvent)];
                case 1:
                    res = _a.sent();
